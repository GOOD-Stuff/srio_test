...
HD_PWD='C:/Projects/srio_test/srio_test/srio_test.runs/srio_gen2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log srio_gen2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source srio_gen2_0.tcl
