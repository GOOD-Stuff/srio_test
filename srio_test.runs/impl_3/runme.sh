...
HD_PWD='C:/Projects/srio_test/srio_test/srio_test.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log srio_example_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source srio_example_test.tcl -notrace
