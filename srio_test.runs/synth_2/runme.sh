...
HD_PWD='C:/Projects/srio_test/srio_test/srio_test.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log srio_example_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source srio_example_test.tcl
