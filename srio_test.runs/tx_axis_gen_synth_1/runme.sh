...
HD_PWD='C:/Projects/srio_test/srio_test/srio_test.runs/tx_axis_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tx_axis_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tx_axis_gen.tcl
