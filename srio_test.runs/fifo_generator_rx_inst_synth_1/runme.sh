...
HD_PWD='C:/Projects/srio_test/srio_test/srio_test.runs/fifo_generator_rx_inst_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_generator_rx_inst.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_generator_rx_inst.tcl
