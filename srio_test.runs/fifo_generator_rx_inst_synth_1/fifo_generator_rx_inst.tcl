...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir C:/Projects/srio_test/srio_test/srio_test.runs/fifo_generator_rx_inst_synth_1 -new_name fifo_generator_rx_inst -ip [get_ips fifo_generator_rx_inst]]

if { $cached_ip eq {} } {

synth_design -top fifo_generator_rx_inst -part xc7k325tffg676-1 -mode out_of_context

#---------------------------------------------------------
# Generate Checkpoint/Stub/Simulation Files For IP Cache
#---------------------------------------------------------
catch {
 write_checkpoint -force -noxdef -rename_prefix fifo_generator_rx_inst_ fifo_generator_rx_inst.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ fifo_generator_rx_inst_stub.v
 lappend ipCachedFiles fifo_generator_rx_inst_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ fifo_generator_rx_inst_stub.vhdl
 lappend ipCachedFiles fifo_generator_rx_inst_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ fifo_generator_rx_inst_sim_netlist.v
 lappend ipCachedFiles fifo_generator_rx_inst_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ fifo_generator_rx_inst_sim_netlist.vhdl
 lappend ipCachedFiles fifo_generator_rx_inst_sim_netlist.vhdl

 config_ip_cache -add -dcp fifo_generator_rx_inst.dcp -move_files $ipCachedFiles -use_project_ipc -ip [get_ips fifo_generator_rx_inst]
}

rename_ref -prefix_all fifo_generator_rx_inst_

write_checkpoint -force -noxdef fifo_generator_rx_inst.dcp
