...
HD_PWD='C:/Projects/srio_test/srio_test/srio_test.runs/dbg_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dbg_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dbg_ila.tcl
